    <div>
<div @click.outside="cart_modal=false" x-show="cart_modal"  class="hidden lg:flex absolute w-80 overflow-y-auto right-0 h-80 bg-white p-4 flex-col items-center">
