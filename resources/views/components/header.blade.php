...
<div x-data="header" class="h-20 flex relative md:px-10 items-center bg-white" >
    ...
    <div class="flex ml-auto gap-4 items-center">
        ...
        <div class="cursor-pointer hover:bg-gray-200 p-2 relative" :class="cart_modal ? 'bg-gray-200' : ''" @click="cart_modal=true">
            <div class="relative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.0" stroke="currentColor" class="w-8 h-8">
        ...
        <div  class="cursor-pointer hover:bg-gray-200  relative" :class="auth ? 'bg-gray-200' : ''">
